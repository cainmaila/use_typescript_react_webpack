...
var RegView_tsx_1 = require('./component/RegView.tsx');
var $ = require('jquery');
...
var routes = (React.createElement(Route, {path: "/"}, React.createElement(IndexRoute, {component: RegView_tsx_1.default}), React.createElement(Route, {path: "c", component: cainui_1.default}), React.createElement(Route, {path: "a", component: cainui_1.default})));
function logger(_a) {
...
var reducer = redux_actions_1.handleActions({
    ...
    'OOK': my_reducer_ts_1.default
}, initialState);
var reduxRouterMiddleware = syncHistory(browserHistory);
var createStoreWithMiddleware = redux_1.applyMiddleware(logger, reg_post, reduxRouterMiddleware);
